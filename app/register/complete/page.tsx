...
export default function CompleteRegistrationPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        setError((response.data && response.data.error) || "Registration failed");
      }
    } catch (e: any) {
  ...
  function Icon({ type }: { type: string }) {
    switch (type) {
      ...
      case "gift":
        return <svg width="20" height="20" fill="none" stroke="#888" strokeWidth="2" viewBox="0 0 24 24"><rect x="2" y="7" width="20" height="12" rx="2"/><path d="M12 7v12M2 11h20"/></svg>;
      default:
        return null;
    }
  }
